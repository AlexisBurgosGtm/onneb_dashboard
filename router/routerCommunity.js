...
router.get("/inventarios", async(req,res)=>{
  ...
  let qr = `SELECT 
              COMMUNITY_INVSALDO_SYNC.EMPNIT, 
              COMMUNITY_EMPRESAS_SYNC.EMPNOMBRE, 
              COMMUNITY_INVSALDO_SYNC.CODPROD, 
              COMMUNITY_PRODUCTOS_SYNC.DESPROD, 
              COMMUNITY_INVSALDO_SYNC.ENTRADAS, 
              COMMUNITY_INVSALDO_SYNC.SALIDAS, 
              COMMUNITY_INVSALDO_SYNC.SALDO, 
              COMMUNITY_INVSALDO_SYNC.DESMARCA, 
              COMMUNITY_INVSALDO_SYNC.COSTOUNITARIO AS COSTO, 
              (ISNULL((COMMUNITY_INVSALDO_SYNC.COSTOUNITARIO * COMMUNITY_INVSALDO_SYNC.SALDO),0)) AS TOTALCOSTO
...
router.get("/inventarioproducto", async(req,res)=>{
  ...
  let qr = `SELECT COMMUNITY_INVSALDO_SYNC.EMPNIT, COMMUNITY_EMPRESAS_SYNC.EMPNOMBRE, COMMUNITY_INVSALDO_SYNC.CODPROD, COMMUNITY_INVSALDO_SYNC.DESPROD, COMMUNITY_INVSALDO_SYNC.ENTRADAS, 
  COMMUNITY_INVSALDO_SYNC.SALIDAS, COMMUNITY_INVSALDO_SYNC.SALDO, COMMUNITY_MARCAS.DESMARCA, COMMUNITY_INVSALDO_SYNC.COSTO, (ISNULL((COMMUNITY_INVSALDO_SYNC.COSTO * COMMUNITY_INVSALDO_SYNC.SALDO),0)) AS TOTALCOSTO
  FROM COMMUNITY_MARCAS RIGHT OUTER JOIN
  COMMUNITY_PRODUCTOS_SYNC ON COMMUNITY_MARCAS.TOKEN = COMMUNITY_PRODUCTOS_SYNC.TOKEN AND COMMUNITY_MARCAS.CODMARCA = COMMUNITY_PRODUCTOS_SYNC.CODMARCA AND 
  COMMUNITY_MARCAS.EMPNIT = COMMUNITY_PRODUCTOS_SYNC.EMPNIT RIGHT OUTER JOIN
  COMMUNITY_INVSALDO_SYNC LEFT OUTER JOIN
  ...
  COMMUNITY_INVSALDO_SYNC.EMPNIT = COMMUNITY_EMPRESAS_SYNC.EMPNIT ON COMMUNITY_PRODUCTOS_SYNC.TOKEN = COMMUNITY_INVSALDO_SYNC.TOKEN AND 
  COMMUNITY_PRODUCTOS_SYNC.CODPROD = COMMUNITY_INVSALDO_SYNC.CODPROD AND COMMUNITY_PRODUCTOS_SYNC.EMPNIT = COMMUNITY_INVSALDO_SYNC.EMPNIT
  WHERE (COMMUNITY_INVSALDO_SYNC.TOKEN = '${token}') AND (COMMUNITY_INVSALDO_SYNC.DESPROD LIKE '%${filtro}%') `;
...
router.get("/ventasdia", async(req,res)=>{
  ...
  let qr = `SELECT EMPNIT, DIA, CODDOC, CORRELATIVO, DOC_NOMCLIE AS CLIENTE, 
        TOTALCOSTO AS COSTO, TOTALPRECIO AS PRECIO, RECARGOTARJETA AS RECARGO, 
        (TOTALPRECIO+RECARGOTARJETA) AS IMPORTE,(TOTALPRECIO+RECARGOTARJETA)-TOTALCOSTO AS UTILIDAD,
        ISNULL(FEL_UUDI,'SN') AS FELID

...
router.get("/ventasmesdia", async(req,res)=>{
  ...
  WHERE (COMMUNITY_DOCUMENTOS_SYNC.EMPNIT = '${empnit}') AND (COMMUNITY_DOCUMENTOS_SYNC.ANIO = ${anio}) AND (COMMUNITY_DOCUMENTOS_SYNC.MES = ${mes}) AND (COMMUNITY_DOCUMENTOS_SYNC.STATUS <> 'A') AND 
